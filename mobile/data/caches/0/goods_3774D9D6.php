<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:47:"E:/www/tgroupon/mobile/themes/miqinew/goods.dwt";i:1;s:58:"E:/www/tgroupon/mobile/themes/miqinew/library/comments.lbi";i:2;s:72:"E:/www/tgroupon/mobile/themes/miqinew/library/page_footer_tianxin100.lbi";}s:7:"expires";i:1478251373;s:8:"maketime";i:1478247773;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="TGROUPON v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>娇韵诗超V型纤容紧致瘦脸面膜75ml_面膜_面部护理_护肤_tgroupon分销系统 TG触屏版</title>
...
<link href="themes/miqinew/ectouch.css?id=10" rel="stylesheet" type="text/css" />
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201502/thumb_img/17_thumb_G_1425037493452.jpg"  alt="娇韵诗超V型纤容紧致瘦脸面膜75ml" /></a></div>-->
      <ul>
	  <!--li><a href="javascript:showPic()"><img alt="" src="http://localhost:8080/images/201502/source_img/17_G_1425037493537.jpg"/></a></li-->
	  <li><a href="javascript:showPic()"><img alt="" src="../images/201502/source_img/17_G_1425037493537.jpg"/></a></li>
              </ul>
    </div>
    <div class="icons">
      <ul>
...
<tr>
<td  style="width:2.5rem;height: 2.5rem;"><br />
<b>Warning</b>:  Illegal string offset 'headimgurl' in <b>E:\www\tgroupon\mobile\include\cls_template.php(1177) : eval()'d code</b> on line <b>196</b><br />
</td> <td>     <p style="color:rgb(253, 250, 250)"><br />
<b>Warning</b>:  Illegal string offset 'headimgurl' in <b>E:\www\tgroupon\mobile\include\cls_template.php(1177) : eval()'d code</b> on line <b>196</b><br />
</p>
...
<!--甜心修改兼容收藏
  <a class="collect" id="collect_box" href="javascript:collect(17)" style="display: inline;"></a>-->
  <div class="title">
    <h1> 娇韵诗超V型纤容紧致瘦脸面膜75ml </h1>
  </div>
    <div class="title">
    柔滑轻盈的慕斯乳霜质地，紧致并维护肤质，可消除浮肿，提升面部轮廓！ 
  </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>275</span></b>　    <del>￥<span>396</span></del> 
    </li>
     
	    <li>	
	注册用户：<b class="price" >￥<span>275</span></b></li>
  </ul>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(17)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
        ...
        <ul class="ul2">
          ...
          <h2>颜色：</h2>
            <div class="items">
                    ...
                    <label for="spec_value_201">黑色-<font class="price">982</font></label> 
        ...
        <ul class="quantity">
          ...
          <div class="items"> <span class="ui-number radius5"> 
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="985" type="number" />
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(17)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(17);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://localhost:8080/images/201502/source_img/17_G_1425037493537.jpg"> </div>
            <div id="right">
              <p>娇韵诗超V型纤容紧致瘦脸面膜75ml</p>
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
	  		...
	  		<img src="http://localhost:8080/images/upload/image/20150228/20150228034345_13548.jpg" alt="" />	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:17;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>
  </div>
...
<script>
  wx.config({
    ...
    timestamp: 1478247773,
    nonceStr: '11o8oRt10LCuzQkG',
    signature: '7cc3a2fa222aea641b8680a162a2f087d46e1219',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '娇韵诗超V型纤容紧致瘦脸面膜75ml',
      desc: '娇韵诗超V型纤容紧致瘦脸面膜75ml',
      link: 'http://localhost:8080/mobile/goods.php?id=17&u=1628',
      imgUrl: 'http://localhost:8080/images/201502/source_img/17_G_1425037493537.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(17)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(17);">加入购物车</button>
