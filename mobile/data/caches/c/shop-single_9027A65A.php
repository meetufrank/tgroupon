<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:63:"/www/web/yoga/public_html/mobile/themes/miqinew/shop-single.dwt";i:1;s:56:"/www/web/yoga/public_html/mobile/themes/miqinew/head.dwt";}s:7:"expires";i:1483448807;s:8:"maketime";i:1483445207;}<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="inner">
          ...
          <a href="#cart" class="toolbar-toggle" id="zhankai">
            <i>
             ...
             <span class="count " id="cart_count">1</span>
            </i>
          </a>
        ...
        <div class="toolbar-section" id="userinfo" >
            ...
            <div class="quotation pull-left" style="width:auto;">
              <div class="quotation-author-ava pull-left">
                <img class="" src="http://wx.qlogo.cn/mmopen/nLB8Q0kJUtuyEX4UlWgTg8poZS7XQeQ1UekmNnrpzQv3LFW7tpCHjLZXBP3JcpCXxV3Dl319mn884kuTGrqCtlbZibj49c8PJ/0" alt="James Cameron">
              </div>
              &nbsp;&nbsp;
              <span style="display:inline-block; line-height:74px;">Frank</span>
            </div>
            </div>
         ...
         <div class="toolbar-section" id="cart">
          <div class="shopping-cart">
              ...
              <label class="checkbox">
                ...
                <input style="position: absolute; opacity: 0;" type="checkbox" value="2588" checked="checked"  id="rec_id" name="rec_check">
                <ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins>
                </label>
                <a href="shop-single.php?id=191" class="item-thumb">
                <img src="../images/201701/thumb_img/191_thumb_G_1483411161375.jpg" alt="Item">                </a>
                <div class="item-details"><h3 class="item-title">
                <a href="shop-single.php?id=191">情人</a>
                </h3>
                <div>
                <div class="pull-right" style="color:#000" >选择颜色:白色 
外框类型:柱形 
</div>
                <h4 class="item-price" data-price="￥<span>78.00</span>">￥<span>78.00</span></h4>
                </div>
                <div class="count-input">
                <a class="incr-btn" data-action="decrease" href="#" onclick="changenum(2588,-1)">–</a>
                <input class="quantity" type="text" value="1" min="1" max="1000" name="goods_number[2588]" id="goods_number_2588" onkeyup="changenum(2588,0)" readonly>
                <a class="incr-btn" data-action="increase" href="#" onclick="changenum(2588,1)">+</a>
                </div></div>
            ...
            <div class="cart-subtotal space-bottom" id="zongjia">
              ...
              <div class="column">
                <h3 class="amount">￥<span>78.00</span></h3>
              </div>
            </div>
...
function addToCartResponse(result)
{
  ...
  else
  {
    ...
    <section class="fw-section bg-gray padding-top-3x">
      <div class="swiper-container">
            <div class="swiper-wrapper">
											<div class="swiper-slide"><img src="../images/201701/goods_img/191_P_1483411161346.JPG"></div>
											<div class="swiper-slide"><img src="../images/201701/goods_img/191_P_1483411441148.JPG"></div>
											<div class="swiper-slide"><img src="../images/201701/goods_img/191_P_1483411441522.JPG"></div>
					            </div>
    ...
    <section class="fw-section bg-gray padding-bottom-3x  hidden-xs">
     <input id="goodsid" type="hidden" value="191">
      <div class="container">
            ...
            <div class="pc-detaile-right col-lg-8 col-md-8 col-sm-8 hidden-xs">
           		<div class="pc-dright-top">
                    <form  name="ECS_FORMBUY">
                                                      <input type="hidden" name="spec_225" value="" >
                            ...
                            <span style="float:left; margin-top:5px;">选择颜色:</span>
                              <ul>
                              <input type="hidden" name="" value="376" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(376,225,0)" class="pc-group-detail" id="type_376" data-type="376">白色<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="378" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(378,225,0)" class="pc-group-detail" id="type_378" data-type="378">橙色<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="379" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(379,225,0)" class="pc-group-detail" id="type_379" data-type="379">青色<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="380" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(380,225,0)" class="pc-group-detail" id="type_380" data-type="380">绿色<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="381" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(381,225,0)" class="pc-group-detail" id="type_381" data-type="381">紫色<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="382" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(382,225,0)" class="pc-group-detail" id="type_382" data-type="382">淡蓝<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="383" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(383,225,0)" class="pc-group-detail" id="type_383" data-type="383">粉色<img src=""></a>
                                </li>
                                                            </ul>
                              <div class="clear"></div>
                          </div>
                                                      <input type="hidden" name="spec_226" value="" >
                            ...
                            <span style="float:left; margin-top:5px;">外框类型:</span>
                              <ul>
                              <input type="hidden" name="" value="377" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(377,226,1)" class="pc-group-detail" id="type_377" data-type="377">椭圆<img src=""></a>
                                </li>
                              <input type="hidden" name="" value="384" >
                                <li>
                                    <a href="#" onclick="attrshuaixuan(384,226,1)" class="pc-group-detail" id="type_384" data-type="384">柱形<img src=""></a>
                                </li>
                                                            </ul>
                              <div class="clear"></div>
                          </div>
                ...
                <div class="pc-dright-bottom">
                   ...
                   <div class="col-lg-2 col-md-2 col-sm-2" style="padding-top:8px;min-height:48px;">
                        <a href="#" class="add-to-cart"  onClick="addToCart(191)">
                            <em>放入购物车</em>
                        </a>
                   </div>
      ...
      <!--   <div class="mobile-cart-color" id="mobile-select-color"><input  name="spec_1"  value="367"/>
        ...
        <div class="mobile-cart-border"><input  name="spec_4"  value="397"/>
            ...
            <div class="clear"></div>
                          ...
                          <p class="mobile-cart-border-text">选择颜色</p>
                          <p class="mobile-cart-border-text">外框类型</p>
                 </form>
    </section>
    <div class="clear"></div>
    ...
    <div class="row">
       <div class="artist-lf col-lg-6 col-md-6 col-sm-6">
	             		<p>
            	<img src="/mobile/images/logo/20170103183407_926.png" style="width:80px;height:80px;border:1px solid transparent;border-radius:50px; float:left;">
            	<span style="margin-top:20px;margin-left:15px; margin-right:15px;display:inline-block; font-size:20px; font-weight:blod;">kitty</span>
            	<img src="themes/miqinew/img/shugang.png" style="display:inline-block; width:1px; height:30px;">
            	<span style="margin-top:15px;margin-left:15px;display:inline-block;font-size:20px; font-weight:blod;">中国</span>
           	</p>
		         </div>
...
<!--        <li><a href="#reviews" role="tab" data-toggle="tab">Reviews <sup>3</sup></a></li>-->
	...
	<img src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170103/20170103190449_18368.jpg" alt="" /><img src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170103/20170103190450_19196.jpg" alt="" /> 
</p>
<p style="text-align:center;">
	<img src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170103/20170103190450_12022.jpg" alt="" /><img src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170103/20170103190450_85975.jpg" alt="" /><img src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170103/20170103190451_38562.jpg" alt="" /><img src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170103/20170103190451_85021.jpg" alt="" /> 
</p>                          </div>
        </div>
        <div role="tabpanel" class="tab-pane transition fade" id="additional">
          <div class="row">
              ...
              <table class="table-no-border">
                <tr>
                  <th>尺寸:</th>
                  <td>高32.5cm；宽12cm；高28cm；宽11.5cm</td>
                </tr>
              </table>
            </div>
                        <div class="col-md-6">
    ...
    <div class="mobile-foot col-xs-12 hidden-sm hidden-md hidden-lg" style="position:fixed;bottom:0;padding:0px;">
		<div class="col-xs-6" style="padding:0px;">
        	<a href="#" class="mobile-add-to-cart" onClick="addToCart(191)" >
              放入购物车
            </a>
        </div>
        <div class="col-xs-6" style="padding:0px;">
         <a href="#" class="mobile-add-to-cart-pay" onClick="addToCart(191,'',1)" >
              立即支付
         </a>
        </div>
    </div>
