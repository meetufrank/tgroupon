<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:63:"/www/web/yoga/public_html/mobile/themes/miqinew/shop-single.dwt";i:1;s:56:"/www/web/yoga/public_html/mobile/themes/miqinew/head.dwt";i:2;s:56:"/www/web/yoga/public_html/mobile/themes/miqinew/foot.dwt";}s:7:"expires";i:1487656743;s:8:"maketime";i:1487653143;}<!DOCTYPE html>
<html lang="en">
<head>
...
<script src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
  ...
  wx.config({
    ...
    timestamp: '1487653143',
    nonceStr: 'kDL4ttrAPS5ujQhW',
    signature: 'c1d9915228523af2dad0e1949a898a078cf9dbc9',
  jsApiList: [
  'checkJsApi',
  'onMenuShareTimeline',
...
wx.ready(function(){
 wx.onMenuShareAppMessage({
      ...
      desc: '商品详情内容',
      link: '',
      imgUrl: 'http://meetuuu.com/mobile/admin/uploads/bc2e00021dba09368a1c800f74e92aae.jpg',
  ...
  wx.onMenuShareTimeline({
    ...
    <section class="hero-slider">
      <div class="inner">
                    <div class="slide pc-thumbnail" style="background-image:url(../images/201702/goods_img/25_P_1487539802644.jpg);"></div>
                    <div class="slide pc-thumbnail" style="background-image:url(../images/201702/goods_img/25_P_1487539802409.jpg);"></div>
              </div>
    </section>
    
    
    <section class="fw-section bg-gray padding-bottom-3x visible-lg visible-md">
      <input id="goodsid" type="hidden" value="25">
      <div class="container pc-mobile-container">
        <div class="product-info padding-top-2x text-center">
          <h1 class="h2 space-bottom-half">陶艺小花瓶(测试)</h1>
          <h2 class="hidden-xs" style="color:#E7322E;" id="pc_price">￥0.40</h2>
          
            <div class="pc-detaile-left col-lg-4 col-md-4 col-sm-4 hidden-xs">
                                     <img src="././admin/uploads/bc2e00021dba09368a1c800f74e92aae.jpg" class="pc-thumbnail">
                            </div>
            ...
            <div class="pc-detaile-right col-lg-8 col-md-8 col-sm-8 hidden-xs">
              <div class="pc-dright-top">
                  ...
                  <form  name="ECS_FORMBUY">
                                                    <input type="hidden" name="spec_239" value="482" >
                            <div class="pc-group-select col-lg-6 col-md-6 col-sm-6 type_arr" id="pc-select-group0">
                              <span class="pc-company-name" style="float:left;">尺寸:</span>  
                                <ul>
                                    
                                                                           <li>
                                            <a href="#" onclick="attrshuaixuan(482,239,0,0)" class="pc-group-detail pc-group-change" id="type_482" data-type="482">
                                                                                              13.8*8.5                                            
                                        </a>
                                        </li>
                ...
                <div class="pc-dright-bottom">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3" style="padding-top:8px;min-height:48px;">
                         <a href="#" class="add-to-cart-pay" onClick="addToCart(25,0,0,0);" >
                                <em>放入购物车</em>
                         </a>
                    </div>
                   <div class="col-lg-2 col-md-2 col-sm-2"  style="padding-top:8px;min-height:48px;" >
                        <a href="#" class="add-to-cart" onClick="addToCart(25,0,1,0);">
                            <em>立即支付</em>
                        </a>
                   </div>
    ...
    <section class="mobile-detail visible-xs visible-sm">
      <div class="mobile-thumbnail col-xs-5" style="padding:20px;">
                           <img src="././admin/uploads/bc2e00021dba09368a1c800f74e92aae.jpg" id="Mobilethumbnail" class="mobile-thumbnail">
                  </div>
        <div class="col-xs-7">
            <div class="mobile-detail-1">
                <span class="mobile-shop-name col-xs-9" style="">陶艺小花瓶(测试)</span><span class="sb-twitter aiheart col-xs-3">
                <i id="shochang"class="fa fa-heart "></i></span>
            </div>
            <div class="clear"></div>
            <div class="mobile-shop-detail col-xs-12">
              <div class="mobile-shop-price col-xs-4" id="mobile_price">¥0.40</div>
                <div class="col-xs-8">
        ...
        <div class="clear"></div>
          ...
          <form  name="ECS_FORMBUY_MOBILE">
                            <input type="hidden" name="spec_239" value="482" class="mobile_input">
                  <p class="mobile-cart-group-text mobile_name">尺寸</p>
                  <div class="mobile-cart-group type_arr mobile_div">
                      <ul class="mobile-cart-group-select mobile_li" id="mobile-groupbox">
                                                         <li>
                                   <a onclick="attrshuaixuan(482,239,0,1)" href="#"  class="mobile-cart-border-details pc-group-change"
                                                                           id="mobiletype_482"
                                        data-type="482">
                                                                                                     13.8*8.5                                                                                 </a>
                               </li>
  ...
  if($(".mobile_input").length<=1&&$(".mobile_li").length<=1){
    ...
    <div class="row">
       <div class="artist-lf col-lg-6 col-md-6 col-sm-6">
                            ...
                            <p>
                  <img src="/mobile/images/logo/20170216125553_502.jpg" style="width:80px;height:80px;border:1px solid transparent;border-radius:50px; float:left;">
                  <span style="margin-top:20px;margin-left:15px; margin-right:15px;display:inline-block; font-size:16px; font-weight:blod;">Jason</span>
                  <img src="themes/miqinew/img/shugang.png" style="display:inline-block; width:1px; height:30px;">
                  <span style="margin-top:15px;margin-left:15px;display:inline-block;font-size:16px; font-weight:bloder;">American</span>
                </p>
                 </div>
    </div>
    </section>
        ...
        <div role="tabpanel" class="tab-pane transition fade in active" id="description">
          <div class="row space-top">
            <div class="space-bottom" id="xiangqiangimg">
                                   ...
                                   <img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135254_62889.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135255_75370.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135256_41829.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135257_43357.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135258_89909.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135258_28378.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135259_57253.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135259_87122.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135300_91455.jpg" /><img alt="" src="/mobile/include/kindeditor/php/../../../../images/upload/image/20170220/20170220135301_15197.jpg" /> 
<p>
	 
</p>                            </div>
          </div>
      ...
      <div class="row padding-top">
                ...
                <div class="shop-item">
                  <div class="shop-thumbnail">
                    ...
                    <img src="././admin/uploads/92792141eaa4056bb550fbfbbce6d1dd.jpg" alt="Shop item">                  </div>
                  <div class="shop-item-details">
                    <h3 class="shop-item-title"><a href="shop-single.php?id=24">花边镂空吊灯（测试）</a></h3>
                ...
                <div class="shop-item">
                  <div class="shop-thumbnail">
                    ...
                    <img src="././admin/uploads/eba04926246be34857e1d032a1bd3a0f.jpg" alt="Shop item">                  </div>
                  <div class="shop-item-details">
                    <h3 class="shop-item-title"><a href="shop-single.php?id=1">床头灯（测试款不发货）</a></h3>
                    <span class="shop-item-price">
                      <span class="old-price"></span>
                      ￥0.10                    </span>
                  </div>
                ...
                <div class="shop-item">
                  <div class="shop-thumbnail">
                    ...
                    <img src="././admin/uploads/544ffdab6c13e0a4fc7aa8971b8658f4.jpg" alt="Shop item">                  </div>
                  <div class="shop-item-details">
                    <h3 class="shop-item-title"><a href="shop-single.php?id=5">三个灯（测试款不发货）</a></h3>
                    <span class="shop-item-price">
                      <span class="old-price"></span>
                      ￥0.40                    </span>
                  </div>
                ...
                <div class="shop-item">
                  <div class="shop-thumbnail">
                    <a href="shop-single.php?id=23" class="item-link"></a>
                    <img src="././admin/uploads/4bb334d8591ae86561c53b91eca504a1.jpg" alt="Shop item">                  </div>
                  <div class="shop-item-details">
                    <h3 class="shop-item-title"><a href="shop-single.php?id=23">笔筒（测试款不发货）</a></h3>
                    <span class="shop-item-price">
                      <span class="old-price"></span>
                      ￥0.10                    </span>
                  </div>
...
<script type='text/javascript'>
    ...
    <div class="col-xs-6" style="padding:0px;">
          <a href="#" class="mobile-add-to-cart" onClick="addToCart(25,0,0,1);" >
              放入购物车
            </a>
        </div>
        <div class="col-xs-6" style="padding:0px;">
         <a href="#" class="mobile-add-to-cart-pay" onClick="addToCart(25,0,1,1);" >
              立即支付
         </a>
        </div>
    </div>
...
if (viewport().width < 768){
   ...
   $("#xiangqiangimg img").each(function(i){
      str=$(this).attr("src");
      arr[i]=str.replace('/mobile/include/kindeditor/php/../../../../images/upload/image/', "");
   });
   var imgstr=JSON.stringify(arr);
    window.location.href='mobileimg.php?imgstr='+imgstr;
   });
}
  var data=[[{"attr_id":"482","typeid":"239"},{"attr_id":"482","typeid":"239"}]];
...
window._shuxingimgs_="././admin/"+"uploads/bc2e00021dba09368a1c800f74e92aae.jpg";
/*商品数量+1*/
function numAdd(){
