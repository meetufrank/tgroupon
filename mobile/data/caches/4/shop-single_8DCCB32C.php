<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:53:"E:/www/tgroupon/mobile/themes/miqinew/shop-single.dwt";i:1;s:46:"E:/www/tgroupon/mobile/themes/miqinew/head.dwt";}s:7:"expires";i:1483500001;s:8:"maketime";i:1483496401;}<!DOCTYPE html>
<html lang="en">
<head>
...
<input type="hidden" name="" value="361" >
                ...
                <div class="pc-dright-bottom">
                   ...
                   <div class="col-lg-2 col-md-2 col-sm-2" style="padding-top:8px;min-height:48px;">
                        <a href="#" class="add-to-cart"  onClick="addToCart(164)">
                            <em>放入购物车</em>
                        </a>
                   </div>
...
<!--        <li><a href="#reviews" role="tab" data-toggle="tab">Reviews <sup>3</sup></a></li>-->
    ...
    <section class="container padding-top padding-bottom">
      ...
      <div class="row padding-top">
			...
			<div class="col-lg-3 col-sm-6 mobile-indent">
			  <div class="shop-item">
				<div class="shop-thumbnail">
				  ...
				  <img src="../images/201503/goods_img/152_G_1425527082169.jpg" alt="Shop item">
				</div>
			...
			<div class="col-lg-3 col-sm-6 mobile-indent">
			  <div class="shop-item">
				<div class="shop-thumbnail">
				  ...
				  <img src="../images/200905/goods_img/5_G_1241422518773.jpg" alt="Shop item">
				</div>
				<div class="shop-item-details">
			...
			<div class="col-lg-3 col-sm-6 mobile-indent">
			  <div class="shop-item">
				<div class="shop-thumbnail">
				  <a href="shop-single.php?id=27" class="item-link"></a>
				  <img src="../images/200905/goods_img/27_G_1241972894061.jpg" alt="Shop item">
				</div>
				<div class="shop-item-details">
				  <h3 class="shop-item-title"><a href="shop-single.php?id=27">联通100元充值卡</a></h3>
				  <span class="shop-item-price">
					<span class="old-price"></span>
						￥95.00
				  </span>
    ...
    <div class="mobile-foot col-xs-12 hidden-sm hidden-md hidden-lg" style="position:fixed;bottom:0;padding:0px;">
		<div class="col-xs-6" style="padding:0px;">
        	<a href="#" class="mobile-add-to-cart" onClick="addToCart(164)" >
              放入购物车
            </a>
        </div>
        <div class="col-xs-6" style="padding:0px;">
         <a href="#" class="mobile-add-to-cart-pay" onClick="addToCart(164,'',1)" >
              立即支付
         </a>
        </div>
    </div>
