...
<a href="https://open.weixin.qq.com/connect/qrconnect?appid=wx7eee3208b7b59ea1&response_type=code&scope=snsapi_login&redirect_uri=http://uranion.com.cn/mobile/wxlogin.php&state=9d9360d18e266b81d69888227fbbadeb"><img height="156px" width="32px" src="themes/miqinew/images/weixin.png">&nbsp;
</a>
<section class="wrap">
    ...
    <div class="bd"<?php if ($this->_var['action'] == 'register'): ?> style="display:none"<?php endif; ?>>
      <ul>
        <div class="table_box">
		  ...
		  <dl>
   <!--      <dd><a href="https://open.weixin.qq.com/connect/qrconnect?appid=wx7eee3208b7b59ea1&response_type=code&scope=snsapi_login&redirect_uri=http://uranion.com.cn/mobile/user.php&state=9d9360d18e266b81d69888227fbbadeb"><img height="24px" width="23px" src="themes/miqinew/images/weixin.gif">&nbsp;微信
       </a></dd> -->
              <dd>
