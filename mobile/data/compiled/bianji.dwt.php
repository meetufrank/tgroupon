...
<?php $_from = $this->_var['shengshiqu']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'shengshiqu_0_51726700_1482840256');if (count($_from)):
    foreach ($_from AS $this->_var['shengshiqu_0_51726700_1482840256']):
?> 
...
?> 
                <option value="<?php echo $this->_var['province']['region_id']; ?>" <?php if ($this->_var['shengshiqu_0_51726700_1482840256']['province'] == $this->_var['province']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['province']['region_name']; ?></option>
...
?> 
                  <option value="<?php echo $this->_var['city']['region_id']; ?>" <?php if ($this->_var['shengshiqu_0_51726700_1482840256']['city'] == $this->_var['city']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['city']['region_name']; ?></option>
...
?> 
                    <option value="<?php echo $this->_var['district']['region_id']; ?>" <?php if ($this->_var['shengshiqu_0_51726700_1482840256']['district'] == $this->_var['district']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['district']['region_name']; ?></option>
                     <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
                  </select>
                 </div></div></div>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <div class="text-right visible-sm visible-xs"><a href="javascript:getaddr();" id="editAddress" style="text-decoration: underline;">读取微信地址</a></div></form>
    ;
