...
?>
                  ...
                  <div class="col-md-6 check_box"  >
                    <label class="radio radio-inline" style="margin-right:0; padding-top: 4px;" id="label<?php echo $this->_var['consignee']['address_id']; ?>"  >
                     <input type="radio" name="my_co_shipping" <?php if ($this->_foreach['address']['iteration'] == 1): ?>checked<?php endif; ?> value="<?php echo $this->_var['consignee']['address_id']; ?>"  id="address<?php echo $this->_var['consignee']['address_id']; ?>"  >
                     </label>
