...
?>
                  ...
                  <div class="col-md-6 check_box"  >
                    <label class="radio radio-inline" style="margin-right:0; padding-top: 4px;" id="label<?php echo $this->_var['consignee']['address_id']; ?>"  >
                     <input type="radio" name="co_shipping" <?php if ($this->_foreach['address']['iteration'] == 1): ?>checked<?php endif; ?> value="<?php echo $this->_var['consignee']['address_id']; ?>"  id="address<?php echo $this->_var['consignee']['address_id']; ?>"  >
                     </label>
                   <?php echo $this->_var['consignee']['province']; ?><?php echo $this->_var['consignee']['city']; ?><?php echo $this->_var['consignee']['district']; ?><?php echo $this->_var['consignee']['address']; ?>
                  </div>
                  <div class="col-md-3">
                ...
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                   ...
                   <h5 style="margin-top: 15px; margin-left: 18px;"><a href="#" id="Address_Manager" class="toggle-section" style="text-decoration: underline;">新增地址</a></h5>
        </div>
</section>
...
?>
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-sm-3" style="padding-top: 3%;">
                                            <h5>总计：<span class="amount_pay" style="color:#f20000"></span></h5>
                                        </div>
...
?>
                                    ...
                                    <div class="clearfix" style="padding-top:20px; margin:0 0 30px 0; border-top: 1px solid #ededed; ">
                                        <h5 class="text-right">总计：<span class="amount_pay" style="color:#f20000" >
                                        </span></h5>
                                    </div>
...
?>'+
   ...
   $('.order_ok').click(function(){
    var address=$("input[name='co_shipping']");
    var cart_id=[];
