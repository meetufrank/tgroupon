...
<meta charset="utf-8" />
<title><?php echo $this->_var['page_title']; ?> TG触屏版</title>
...
?>
        ...
        <li><a href="javascript:showPic()"><img alt="" src="<?php if ($this->_var['picture']['img_url']): ?><?php echo $this->_var['picture']['img_url']; ?><?php else: ?>../<?php echo $this->_var['picture']['thumb_url']; ?><?php endif; ?>"/></a></li>
