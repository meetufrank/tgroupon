...
?>
    ...
    <section class="container padding-top padding-bottom">
	  ...
	  <?php $_from = $this->_var['ysjzp']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ysjzp_0_32245600_1488257090');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['ysjzp_0_32245600_1488257090']):
        $this->_foreach['no']['iteration']++;
?>
        <div class="col-lg-3 col-sm-6" >
          <div class="shop-item">
            <div class="shop-thumbnail">
              <a href="shop-single.php?id=<?php echo $this->_var['ysjzp_0_32245600_1488257090']['goods_id']; ?><?php echo $this->_var['linestring2']; ?>" class="item-link"></a>

              <img src="././admin/<?php echo $this->_var['ysjzp_0_32245600_1488257090']['attributeimg']; ?>" alt="<?php echo $this->_var['ysjzp_0_32245600_1488257090']['goods_name']; ?>">

            </div>
            <div class="shop-item-details">
              <h3 class="shop-item-title"><a href="#"><?php echo $this->_var['ysjzp_0_32245600_1488257090']['goods_name']; ?></a></h3>
              <span class="shop-item-price">
               ￥<?php echo $this->_var['ysjzp_0_32245600_1488257090']['attributeprice']; ?>
              </span>
            </div>
          </div>
        </div>
