...
?>
		...
		<div class="clearfix">
			...
			<div class="quotation pull-left">
	          ...
	          <div class="pull-right" style="margin-top: 20px;">
                  ...
                  <i class="fa fa-heart" style="width:30px; height:30px;text-align:center; padding-top:5px;"></i>
    ...
    <section class="container padding-top padding-bottom">
	  ...
	  <?php $_from = $this->_var['ysjzp']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ysjzp_0_29715500_1488245752');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['ysjzp_0_29715500_1488245752']):
        ...
        <div class="col-lg-3 col-sm-6" >
          ...
          <div class="shop-item">
            ...
            <div class="shop-thumbnail">
              ...
              <a href="shop-single.php?id=<?php echo $this->_var['ysjzp_0_29715500_1488245752']['goods_id']; ?><?php echo $this->_var['linestring2']; ?>" class="item-link"></a>



              <img src="././admin/<?php echo $this->_var['ysjzp_0_29715500_1488245752']['attributeimg']; ?>" alt="<?php echo $this->_var['ysjzp_0_29715500_1488245752']['goods_name']; ?>">
            ...
            <div class="shop-item-details">
              ...
              <h3 class="shop-item-title"><a href="#"><?php echo $this->_var['ysjzp_0_29715500_1488245752']['goods_name']; ?></a></h3>

              <span class="shop-item-price">

               ￥<?php echo $this->_var['ysjzp_0_29715500_1488245752']['attributeprice']; ?>
