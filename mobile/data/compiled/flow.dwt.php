...
<section class="wrap" style="padding-bottom:5rem"  >
  <form id="formCart" name="formCart" method="post" action="flow.php">
    <ul class="radius10 itemlist">
      <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_04181500_1482303099');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_04181500_1482303099']):
?>
      <li class="new-tbl-type">
        <div class="itemlist_l new-tbl-cell">
          <?php if ($this->_var['goods_0_04181500_1482303099']['goods_id'] > 0 && $this->_var['goods_0_04181500_1482303099']['extension_code'] != 'package_buy'): ?>
          <a  href="goods.php?id=<?php echo $this->_var['goods_0_04181500_1482303099']['goods_id']; ?>" target="_blank"> <img class="lazy" src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods_0_04181500_1482303099']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods_0_04181500_1482303099']['goods_name']); ?>" /> </a>
          <?php if ($this->_var['goods_0_04181500_1482303099']['parent_id'] > 0): ?>
          <span style="color:#FF0000">（<?php echo $this->_var['lang']['accessories']; ?>）</span>
          <?php endif; ?>
          <?php if ($this->_var['goods_0_04181500_1482303099']['is_gift'] > 0): ?>
          <span style="color:#FF0000">（<?php echo $this->_var['lang']['largess']; ?>）</span>
          <?php endif; ?>
          <?php elseif ($this->_var['goods_0_04181500_1482303099']['goods_id'] > 0 && $this->_var['goods_0_04181500_1482303099']['extension_code'] == 'package_buy'): ?>
          <a href="javascript:void(0)" onClick="setSuitShow(<?php echo $this->_var['goods_0_04181500_1482303099']['goods_id']; ?>)" class="f6"><?php echo $this->_var['goods_0_04181500_1482303099']['goods_name']; ?><span style="color:#FF0000;">（<?php echo $this->_var['lang']['remark_package']; ?>）</span></a>
          <div id="suit_<?php echo $this->_var['goods_0_04181500_1482303099']['goods_id']; ?>" style="display:none">
            <?php $_from = $this->_var['goods_0_04181500_1482303099']['package_goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'package_goods_list');if (count($_from)):
...
?>
          ...
          <?php else: ?>
          <?php echo $this->_var['goods_0_04181500_1482303099']['goods_name']; ?>
          <?php endif; ?>
        </div>
        <div class="desc new-tbl-cell"> <a style="color:#333" href="goods.php?id=<?php echo $this->_var['goods_0_04181500_1482303099']['goods_id']; ?>" target="_blank" class="fragment">
          <h4><?php echo $this->_var['goods_0_04181500_1482303099']['goods_name']; ?></h4>
          </a>
          <div style="clear:both"> </div>
          <?php if ($this->_var['show_goods_attribute'] == 1): ?>
          <p> <?php echo nl2br($this->_var['goods_0_04181500_1482303099']['goods_attr']); ?> </p>
          <?php endif; ?>
          <div class="b"> <em class="price"><?php echo $this->_var['goods_0_04181500_1482303099']['goods_price']; ?></em> <span style="jianju">x </span> <span class="txt">
		  <button type="button" class="decrease" onclick="changenum(<?php echo $this->_var['goods_0_04181500_1482303099']['rec_id']; ?>,-1)">-</button>
            <?php if ($this->_var['goods_0_04181500_1482303099']['goods_id'] > 0 && $this->_var['goods_0_04181500_1482303099']['is_gift'] == 0 && $this->_var['goods_0_04181500_1482303099']['parent_id'] == 0): ?>
            <input class="num" type="text" min="1" max="1000" name="goods_number[<?php echo $this->_var['goods_0_04181500_1482303099']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods_0_04181500_1482303099']['rec_id']; ?>" value="<?php echo $this->_var['goods_0_04181500_1482303099']['goods_number']; ?>" size="4"   onkeyup="changenum(<?php echo $this->_var['goods_0_04181500_1482303099']['rec_id']; ?>,0)"/>
			<button type="button" class="increase" onclick="changenum(<?php echo $this->_var['goods_0_04181500_1482303099']['rec_id']; ?>,1)">+</button>
        ...
        function change_goods_number_response(result)
        {
          ...
          alert(result.message);
            ...
            <?php else: ?>
            <?php echo $this->_var['goods_0_04181500_1482303099']['goods_number']; ?>
            <?php endif; ?>
            </span> <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods_0_04181500_1482303099']['rec_id']; ?>'; "   class="ico_08 cha"> </a> </div>
        </div>
      </li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </ul>
...
?>
		...
		<div class="dl_box" id="payment" style="display:none">
		  <?php $_from = $this->_var['payment_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'payment_0_04281500_1482303099');if (count($_from)):
    foreach ($_from AS $this->_var['payment_0_04281500_1482303099']):
?>
		  <p>
           <input type="radio" class="radio" name="payment" id="payment_<?php echo $this->_var['payment_0_04281500_1482303099']['pay_id']; ?>" value="<?php echo $this->_var['payment_0_04281500_1482303099']['pay_id']; ?>" <?php if ($this->_var['order']['pay_id'] == $this->_var['payment_0_04281500_1482303099']['pay_id']): ?>checked<?php endif; ?> isCod="<?php echo $this->_var['payment_0_04281500_1482303099']['is_cod']; ?>" onclick="selectPayment(this)" <?php if ($this->_var['cod_disabled'] && $this->_var['payment_0_04281500_1482303099']['is_cod'] == "1"): ?>disabled="true"<?php endif; ?> style="vertical-align:middle" /><label for="payment_<?php echo $this->_var['payment_0_04281500_1482303099']['pay_id']; ?>"><?php echo $this->_var['payment_0_04281500_1482303099']['pay_name']; ?> [<?php echo $this->_var['payment_0_04281500_1482303099']['format_pay_fee']; ?>]</label>
           </p>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</div>
        <?php else: ?>
...
?>
    ...
    <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
      <div class="table_box table_box3">
        ...
        <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_04281500_1482303099');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_04281500_1482303099']):
?>
        <dl>
          <dd class="dd1 w60">
            <?php if ($this->_var['goods_0_04281500_1482303099']['goods_id'] > 0 && $this->_var['goods_0_04281500_1482303099']['extension_code'] == 'package_buy'): ?>
            <a href="javascript:void(0)" onClick="setSuitShow(<?php echo $this->_var['goods_0_04281500_1482303099']['goods_id']; ?>)" ><?php echo $this->_var['goods_0_04281500_1482303099']['goods_name']; ?><span style="color:#FF0000;">（<?php echo $this->_var['lang']['remark_package']; ?>）</span></a>
            <?php else: ?>
            <a href="goods.php?id=<?php echo $this->_var['goods_0_04281500_1482303099']['goods_id']; ?>" target="_blank" ><?php echo $this->_var['goods_0_04281500_1482303099']['goods_name']; ?></a>
            <?php if ($this->_var['goods_0_04281500_1482303099']['parent_id'] > 0): ?>
            <span style="color:#FF0000">（<?php echo $this->_var['lang']['accessories']; ?>）</span>
            <?php elseif ($this->_var['goods_0_04281500_1482303099']['is_gift']): ?>
            <span style="color:#FF0000">（<?php echo $this->_var['lang']['largess']; ?>）</span>
            <?php endif; ?>
            <?php endif; ?>
            <?php if ($this->_var['goods_0_04281500_1482303099']['is_shipping']): ?>(<span style="color:#FF0000"><?php echo $this->_var['lang']['free_goods']; ?></span>)<?php endif; ?>
          </dd>
          <dd class="dd2 w10 c999"> x <?php echo $this->_var['goods_0_04281500_1482303099']['goods_number']; ?> </dd>
          <dd class="dd3 w30"> <?php echo $this->_var['goods_0_04281500_1482303099']['formated_subtotal']; ?> </dd>
        </dl>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
