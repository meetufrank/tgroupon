...
?>
    ...
    <section class="wrap">
      <?php $_from = $this->_var['consignee_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('sn', 'consignee_0_86464100_1482732154');if (count($_from)):
    foreach ($_from AS $this->_var['sn'] => $this->_var['consignee_0_86464100_1482732154']):
?>
      <section class="order_box padd1 radius10">
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        <tr>
          <td width="32%" align="right"><?php echo $this->_var['lang']['consignee_name']; ?>：</td>
          <td width="68%" align="left"><?php echo htmlspecialchars($this->_var['consignee_0_86464100_1482732154']['consignee']); ?></td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['phone']; ?>：</td>
          <td align="left"><?php echo $this->_var['consignee_0_86464100_1482732154']['tel']; ?> </td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['detailed_address']; ?>：</td>
          <td align="left"><?php echo htmlspecialchars($this->_var['consignee_0_86464100_1482732154']['address']); ?>
            <?php if ($this->_var['consignee_0_86464100_1482732154']['zipcode']): ?>
            [<?php echo $this->_var['lang']['postalcode']; ?>: <?php echo htmlspecialchars($this->_var['consignee_0_86464100_1482732154']['zipcode']); ?>]
            <?php endif; ?></td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['email_address']; ?>：</td>
          <td align="left"><?php echo htmlspecialchars($this->_var['consignee_0_86464100_1482732154']['email']); ?></td>
        </tr>
        <tr>
          <td colspan="2" align="right"><a href="user.php?act=act_edit_address&id=<?php echo $this->_var['consignee_0_86464100_1482732154']['address_id']; ?>&flag=display">编辑</a> | <a href="user.php?act=drop_consignee&id=<?php echo $this->_var['consignee_0_86464100_1482732154']['address_id']; ?>" onClick="return confirm('您真的要删除该地址吗？');">删除</a></td>
        </tr>
      </table>
      </section>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
