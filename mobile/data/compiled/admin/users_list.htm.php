...
?>
  <tr>
    ...
    <td><?php echo $this->_var['user']['weiyi_num']; ?></td>
	...
	<td align="center">
      ...
      <!-- 生成二维码 -->
       ...
       <?php if ($this->_var['user']['is_line'] == 1): ?>
       <a id="erweimaid" href="users.php?act=erweima&id=<?php echo $this->_var['user']['user_id']; ?>" title="生成二维码链接"><img src="images/icon_docs.gif" border="0" height="16" width="16" /></a>
       <?php endif; ?>
