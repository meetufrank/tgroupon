...
?>
      ...
      <td align="center"><strong>假价格</strong></td>
...
?>
      ...
      <!-- 假价格 -->
      <td align="center"><span onclick="listTable.edit(this, 'edit_falseprice', <?php echo $this->_var['product']['product_id']; ?>)"><?php echo $this->_var['product']['falseprice']; ?></span></td>
...
?>
    ...
    <!-- end for specifications_value -->
      ...
      <td align="center"><input  type="text" name="product_number[]" value="<?php echo $this->_var['product_number']; ?>" size="10"/></td>
        <!-- 假价格 -->
       <td align="center"><input type="text" name="falseprice[]"  value="<?php echo $this->_var['falseprice']; ?>"  size="10"/></td>
