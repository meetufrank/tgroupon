...
?>
      ...
      <td class="label_2" align="center"><?php echo $this->_var['lang']['goods_sn']; ?></td>

      <td class="label_2" align="center">属性关联图片</td>
      <td class="label_2" align="center">属性关联价格</td>
      <td class="label_2" align="center"><?php echo $this->_var['lang']['goods_number']; ?></td>
      <td class="label_2" align="center">&nbsp;</td>
...
?>
      ...
      <td><span onclick="listTable.edit(this, 'edit_product_sn', <?php echo $this->_var['product']['product_id']; ?>)"><?php echo empty($this->_var['product']['product_sn']) ? $this->_var['lang']['n_a'] : $this->_var['product']['product_sn']; ?></span></td>
      ...
      <td  align="center">
                  ...
                  <?php else: ?>
                        <img class="js_logoBox" style="width:100px; height:100px;" src="<?php echo $this->_var['product']['attributeimg']; ?>"/>
                  <?php endif; ?>
      </td>
      <!-- 属性关联价格 -->
      <td><span onclick="listTable.edit(this, 'edit_attributeprice', <?php echo $this->_var['product']['product_id']; ?>)"><?php echo $this->_var['product']['attributeprice']; ?></span></td>

      <td><span onclick="listTable.edit(this, 'edit_product_number', <?php echo $this->_var['product']['product_id']; ?>)">
...
?>
    ...
    <!-- end for specifications_value -->
      ...
      <td><input type="text" name="attributeprice[]"  value="<?php echo $this->_var['attributeprice']; ?>"  size="10"/></td>
      <td><input  type="text" name="product_number[]" value="<?php echo $this->_var['product_number']; ?>" size="10"/></td>
