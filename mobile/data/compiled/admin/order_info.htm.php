...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <!--<td><div align="right"><strong><?php echo $this->_var['lang']['label_shipping']; ?></strong></div></td> -->
    <td><div align="right">
    <strong><?php echo $this->_var['lang']['label_shipping']; ?></strong>
    </div></td>
    ...
    function edit(){
       ...
       var  myselect=document.getElementById("shippling").value;

       window.location.href="order.php?act=step_post&step=shipping&order_id=<?php echo $this->_var['order']['order_id']; ?>&step_act=edit&shipping="+myselect;

       }
    </script>
    <a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=shipping" class="special" onclick="">编辑</a>&nbsp;&nbsp;<input type="button" onclick="window.open('order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>&shipping_print=1')" class="button" value="<?php echo $this->_var['lang']['print_shipping']; ?>"> <?php if ($this->_var['order']['insure_fee'] > 0): ?>（<?php echo $this->_var['lang']['label_insure_fee']; ?><?php echo $this->_var['order']['formated_insure_fee']; ?>）<?php endif; ?>
    </td>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td colspan="5">
    <!-- 一键发货begin -->
<?php if ($this->_var['order']['pay_status'] == 2 && $this->_var['order']['shipping_status'] != 1 && $this->_var['order']['order_status'] == 1): ?><input name="invoice_no" type="text" style="color:#00F" value="<?php echo $this->_var['order']['order_sn']; ?>" /><input name="to_shipping" type="submit" style="color:#F00" value="快速发货" class="button"/><?php endif; ?>
<!-- 一键发货end-->
