...
<?php echo $this->fetch('pageheaderyishujia.htm'); ?>
...
?>
  ...
  <tr>
    ...
    <td align="center" ><?php echo $this->_var['list']['ysj_fencheng']; ?></td>

    <td align="center" >
        <?php if ($this->_var['list']['hav_logo'] != ''): ?>
          <img style="width:100px; height:100px;"  src="<?php echo $this->_var['list']['hav_logo']; ?>">
          <?php else: ?>
          暂无logo
        <?php endif; ?>
    </td>
    ...
    <td align="center" >
        <?php if ($this->_var['list']['sjsbanner'] != ''): ?>
          <img style="width:100px; height:100px;"  src="<?php echo $this->_var['list']['sjsbanner']; ?>">
          <?php else: ?>
          暂无branner图片
        <?php endif; ?>
    </td>
...
<!--       <a href="admin_logs.php?act=list&id=<?php echo $this->_var['list']['user_id']; ?>" title="<?php echo $this->_var['lang']['view_log']; ?>"><img src="images/icon_view.gif" border="0" height="16" width="16"></a>&nbsp;&nbsp; -->
      ...
      <a href="privilegeyishujia.php?act=edit&id=<?php echo $this->_var['list']['user_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16"></a>&nbsp;&nbsp;
