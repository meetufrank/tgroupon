...
<?php echo $this->smarty_insert_scripts(array('files'=>'../data/static/js/utils.js,./js/selectzone.js,./js/colorselector.js,./js/jquery.js')); ?>
...
?>
         ...
         <tr>
            ...
            <td><input type="checkbox" name="is_best" value="1" <?php if ($this->_var['goods']['is_best']): ?>checked="checked"<?php endif; ?> />猜你喜欢<?php echo $this->_var['lang']['is_best']; ?> <input type="checkbox" name="is_new" value="1" <?php if ($this->_var['goods']['is_new']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_new']; ?>
            <input type="checkbox" name="is_hot" value="1" <?php if ($this->_var['goods']['is_hot']): ?>checked="checked"<?php endif; ?> />折扣优惠
            <input type="checkbox" name="is_very" value="1" <?php if ($this->_var['goods']['is_very']): ?>checked="checked"<?php endif; ?> />特别优惠</td>
           ...
           <!-- <tr>
            ...
            <td><select name="father_id" id="suppliers_id">

                <option value="0">不选</option>



        <?php $_from = $this->_var['firm_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'fa');if (count($_from)):
    foreach ($_from AS $this->_var['fa']):
?>

                <option value="<?php echo $this->_var['fa']['user_id']; ?>" <?php if ($this->_var['fa']['user_id'] == $this->_var['goods']['father_id']): ?> selected="true" <?php endif; ?>><?php echo $this->_var['fa']['user_name']; ?></option>
        ...
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <tr>
            ...
            <td><select name="arter_id" id="suppliers_id">

                <option value="0">不选</option>

        <?php $_from = $this->_var['art_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'fa');if (count($_from)):
    foreach ($_from AS $this->_var['fa']):
?>

                <option value="<?php echo $this->_var['fa']['user_id']; ?>"  <?php if ($this->_var['fa']['user_id'] == $this->_var['goods']['arter_id']): ?> selected="true" <?php endif; ?> ><?php echo $this->_var['fa']['user_name']; ?></option>
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
          ...
          <tr>
            ...
            <td class="label">快递费：</td>

            <td><input type="text" name="more_price" <?php if ($this->_var['goods']['more_price']): ?>value="<?php echo $this->_var['goods']['more_price']; ?>"<?php else: ?>value="0.00"<?php endif; ?> size="20" onblur="priceSetted()"/></td>
...
?>
          ...
          <tr id="promote_4" style="display:none;">
          ...
          <tr style="display:none;">
            ...
            <td>
              ...
              <br /><input style="display:none;" type="text" size="40" value="<?php echo $this->_var['lang']['lab_picture_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_picture_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_img_url"/>
          ...
          <tr>
              <td class="label">特别优惠图片:</td>
              <td>
                <input type="file" name="veryimg" size="35"  />
                <?php if ($this->_var['goods']['veryimg']): ?>
                <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['veryimg']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?>
              </td>
           ...
           <tr>
            <td class="label">列表页显示图片：</td>
            <td>
              <input type="file" name="tuijie_img" size="35" />
              <?php if ($this->_var['goods']['listimg']): ?>
                <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['listimg']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?>
            </td>
...
?>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="text" size="40" value="<?php echo $this->_var['lang']['img_file']; ?>" style="display:none; color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['img_file']; ?>'){this.value='http://';this.style.color='#000';}" name="img_file[]"/>
...
?>
...

  {
     ...
     /* var idx   = rowindex(src);
	  ...
	  var html= src.innerHTML.replace(/(.*)(attr_img\[)(.*)(\])(.*)/i, "$1$2$4$5");
