...
<h1>
<span class="action-span"><a href="wxch_qr.php?act=add&type=limitscene">添加永久二维码</a></span>
<span class="action-span"><a href="wxch_qr.php?act=add&type=scene">添加临时二维码</a></span>
...
<table cellspacing='1' cellpadding='3' id='list-table'>
  <tr>
    <th><a href="#">应用场景</a></th>
    <th><a href="#">二维码类型</a></th>
    <th><a href="#">功能</a></th>
    <th><a href="#">扫描量(未关注)</a></th>
    <th><a href="#">扫描量(已关注)</a></th>
    <th>操作</th>
  </tr>
...
?>
    ...
    <td align="center"><?php echo $this->_var['list']['subscribe']; ?></td>
    <td align="center"><span><?php echo $this->_var['list']['scan']; ?></span></td>
    <td align="center" nowrap="true"><span>
      ...
      <a href="wxch_qr.php?act=edit<?php if ($this->_var['list']['type_name'] == QR_SCENE): ?>&type=scent<?php else: ?>&type=limit<?php endif; ?>&id=<?php echo $this->_var['list']['qid']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['qid']; ?>, '您确认要删除这个二维码吗？')" title="移除"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--  --></span>
    </td>
   </tr>
