...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr id="measure_unit" style="display:none;">
...
?>
      ...
      <tr>
        <td class="label">分类小图标:</td>
        <td><input type="file" name="cat_ico" id="cat_ico" size="50"><br /><?php if ($this->_var['cat_info']['cat_ico']): ?><img src="../data/cat_ico/<?php echo $this->_var['cat_info']['cat_ico']; ?>" height="80" width="80" /> <input type="button" value="删除图标" onclick="if (confirm('确认删除分类图标吗?'))location.href='category.php?act=drop_cat_ico&id=<?php echo $this->_var['cat_info']['cat_id']; ?>'"><?php endif; ?></td>
      </tr>
      <tr>
