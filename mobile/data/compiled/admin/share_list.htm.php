...
<table cellpadding="3" cellspacing="1">
  ...
  <tr><td align="center" style="font-size:150%" colspan="12">我的直销</td></tr>
  <?php $_from = $this->_var['user_list1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user');if (count($_from)):
...
?>
  <tr>
	...
	<td align="center"><a href="users.php?act=myorder&user_id=<?php echo $this->_var['user']['user_id']; ?>">查看</a></td>
  </tr>
  <?php endforeach; else: ?>
  <tr><td class="no-records" colspan="12"><?php echo $this->_var['lang']['no_records']; ?></td></tr>
  <?php endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <tr><td align="center" style="font-size:150%" colspan="12">二级分销</td></tr>
  <?php $_from = $this->_var['user_list2']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user');if (count($_from)):
    foreach ($_from AS $this->_var['user']):
?>
  <tr>
    <td><?php echo $this->_var['user']['user_id']; ?></td>
  ...
  <tr><td class="no-records" colspan="12"><?php echo $this->_var['lang']['no_records']; ?></td></tr>
  <?php endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <tr><td align="center" style="font-size:150%" colspan="12">三级分销</td></tr>
  <?php $_from = $this->_var['user_list3']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user');if (count($_from)):
    foreach ($_from AS $this->_var['user']):
?>
  <tr>
    <td><?php echo $this->_var['user']['user_id']; ?></td>
  ...
  <tr><td class="no-records" colspan="12"><?php echo $this->_var['lang']['no_records']; ?></td></tr>
  <?php endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <tr><td align="center" style="font-size:150%" colspan="12">四级分销</td></tr>
  <?php $_from = $this->_var['user_list4']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user');if (count($_from)):
    foreach ($_from AS $this->_var['user']):
?>
  <tr>
    <td><?php echo $this->_var['user']['user_id']; ?></td>
