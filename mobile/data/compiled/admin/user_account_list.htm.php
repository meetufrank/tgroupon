...
?>
  ...
  <?php $_from = $this->_var['txsq']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
    <tr>
        ...
        <td align="center"><?php echo $this->_var['item']['time']; ?></td>
        <td align="center"><?php if ($this->_var['item']['status'] == 0): ?><?php echo $this->_var['item']['datetime']; ?><?php else: ?><?php endif; ?></td>
        <td align="center"><?php if ($this->_var['item']['status'] == 0): ?>未受理<?php elseif ($this->_var['item']['status'] == 1): ?>已受理<?php elseif ($this->_var['item']['status'] == 2): ?>拒绝<?php elseif ($this->_var['item']['status'] == 3): ?>已完成<?php endif; ?></td>
        <td align="center"><a href="user_account.php?act=edit&id=<?php echo $this->_var['item']['id']; ?>" title="<?php echo $this->_var['lang']['surplus']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a></td>
    </tr>
