...
<div class="main-div">
<form method="post" action="users.php" name="theForm"  enctype="multipart/form-data"  onsubmit="return validate()">
<table width="100%" >
  <tr>
  ...
  -->
  <tr>
    <td class="label">会员身份:</td>
    <td><select name="shenfen">
      <option value="0" selected>普通会员</option>
      <option value="1" <?php if ($this->_var['user']['is_line'] == 1): ?>selected<?php endif; ?>>空间主</option>
    </select></td>
  </tr>
  ...
  <tr>
    ...
    <td>
       <input name="hav_money" type="text" readonly="flase" value="<?php echo $this->_var['user']['hav_money']; ?>" size="10" />
       可提现金额不可编辑
    </td>
  </tr>
  ...
  <!-- 线下店推荐分成 -->
  <tr>
    <td class="label">空间主推荐分成:</td>
    <td>
       <input name="tj_fencheng" type="text"  value="<?php echo $this->_var['user']['tj_fencheng']; ?>" size="10" />
    </td>
  </tr>
  <tr>
    <td class="label">空间主产品分成:</td>
    <td>
       <input name="xs_fencheng" type="text"  value="<?php echo $this->_var['user']['xs_fencheng']; ?>" size="10" />
    </td>
  </tr>
