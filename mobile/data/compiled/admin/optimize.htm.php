...
<!-- end  list -->
<?php endif; ?>
<?php if ($this->_var['act'] == show_tables): ?>
<div class="list-div" id="listDiv">
<table cellspacing='1' cellpadding='3' id='listTable'>
  <tr>
    <th>字段</th>
...
?>
    <tr>
      <td class="first-cell"><?php echo $this->_var['item']['Field']; ?></td>
      <td align ="left"><?php echo $this->_var['item']['Type']; ?></td>
      <td align ="right"><?php echo $this->_var['item']['Null']; ?></td>
      <td align ="right"><?php echo $this->_var['item']['Key']; ?></td>
      <td align ="right"><?php echo $this->_var['item']['Default']; ?></td>
      <td align ="left"><?php echo $this->_var['item']['Extra']; ?></td>
    </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
</div>
