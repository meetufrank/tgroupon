...
<!--     <td valign="top" nowrap="nowrap"><input type="checkbox" name="delivery_id[]" value="<?php echo $this->_var['delivery']['delivery_id']; ?>" /><?php echo $this->_var['delivery']['delivery_sn']; ?></td>
    ...
    <td align="center"><?php echo $this->_var['delivery']['id']; ?></td>

      <td align="center"><?php echo $this->_var['delivery']['xxdname']; ?></td>

      <td align="center"><?php echo $this->_var['delivery']['goods_name']; ?></td>

      <td align="center"><?php echo $this->_var['delivery']['username']; ?></td>

      <td align="center"><?php echo $this->_var['delivery']['money']; ?></td>

      <td align="center"><?php if ($this->_var['delivery']['type'] == 0): ?>产品分成<?php elseif ($this->_var['delivery']['type'] == 1): ?>销售分成<?php elseif ($this->_var['delivery']['type'] == 2): ?>艺术家分成<?php elseif ($this->_var['delivery']['type'] == 3): ?>厂商分成<?php endif; ?></td>

      <td align="center"><?php echo $this->_var['delivery']['tcusername']; ?></td>
