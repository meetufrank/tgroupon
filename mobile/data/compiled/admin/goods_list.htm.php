...
<form method="post" action="" name onsubmit="return confirmSubmit(this)">
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <th style="display:none;"><a href="javascript:listTable.sort('shop_price'); "><?php echo $this->_var['lang']['shop_price']; ?></a><?php echo $this->_var['sort_shop_price']; ?></th>

    <th style="display:none;"><a href="javascript:listTable.sort('is_on_sale'); "><?php echo $this->_var['lang']['is_on_sale']; ?></a><?php echo $this->_var['sort_is_on_sale']; ?></th>

    <th><a href="javascript:listTable.sort('is_best'); ">猜你喜欢<?php echo $this->_var['lang']['is_best']; ?></a><?php echo $this->_var['sort_is_best']; ?></th>

    <th><a href="javascript:listTable.sort('is_new'); "><?php echo $this->_var['lang']['is_new']; ?></a><?php echo $this->_var['sort_is_new']; ?></th>

    <th><a href="javascript:listTable.sort('is_hot'); ">折扣优惠</a><?php echo $this->_var['sort_is_hot']; ?></th>
    <th>特别优惠图片</th>
	...
	<th style="display:none;"><a href="javascript:listTable.sort('sales_volume_base'); ">销量基数</a><?php echo $this->_var['sort_sales_volume_base']; ?></th>
...
?>
  ...
  <tr>
    ...
    <td align="center" style="display:none;" align="right"><span><?php echo $this->_var['goods']['shop_price']; ?></span></td>

    <td align="center" style="display:none;"><img src="images/<?php if ($this->_var['goods']['is_on_sale']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_on_sale', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
    ...
    <td align="center"><img style="width:100px; height:100px;" src="<?php echo $this->_var['goods']['veryimg']; ?>"></td>
	...
	<td style="display:none;" align="center"><span onclick="listTable.edit(this, 'edit_sales_volume_base', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['sales_volume_base']; ?></span></td>

    <td align="center">

      <a href="../goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img style="display:none;" src="images/icon_view.gif" width="16" height="16" border="0" /></a>
      ...
      <a href="goods.php?act=copy&goods_id=<?php echo $this->_var['goods']['goods_id']; ?><?php if ($this->_var['code'] != 'real_goods'): ?>&extension_code=<?php echo $this->_var['code']; ?><?php endif; ?>" title="<?php echo $this->_var['lang']['copy']; ?>"><img style="display:none;" src="images/icon_copy.gif" width="16" height="16" border="0" /></a>

      <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['goods']['goods_id']; ?>, '<?php echo $this->_var['lang']['trash_goods_confirm']; ?>')" title="<?php echo $this->_var['lang']['trash']; ?>"><img src="images/icon_drop.gif" width="16" height="16" border="0" /></a>
