...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <th><a><?php echo $this->_var['lang']['ad_name']; ?></a></th>
...
?>
 ...
 <!--    <td align="left"><span><?php if ($this->_var['list']['position_id'] == 0): ?><?php echo $this->_var['lang']['outside_posit']; ?><?php else: ?><?php echo $this->_var['list']['position_name']; ?><?php endif; ?></span>
  ...
  <!--   <td align="left"><span><?php echo $this->_var['list']['type']; ?></span></td> -->
    ...
    <td align="center"><span><img style="width:80px;height:50px;" src="../../mobile/data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?>"></span></td>
    <td align="center"><span><?php if ($this->_var['list']['enabled'] == 0): ?>关闭<?php else: ?>开启<?php endif; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['sort']; ?></span></td>
