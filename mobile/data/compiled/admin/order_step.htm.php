...
<?php echo $this->smarty_insert_scripts(array('files'=>'../data/static/js/utils.js,../data/static/js/transport.js,./js/validator.js')); ?>
<?php if ($this->_var['step'] == "consignee"): ?>
<?php echo $this->smarty_insert_scripts(array('files'=>'../data/static/js/region.js')); ?>
<?php endif; ?>
