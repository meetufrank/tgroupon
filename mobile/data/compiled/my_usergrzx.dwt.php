 ...
 <?php if ($this->_var['consignee']['default'] == 1): ?> <span href="#" style="font-size:12px; color: #999; margin-right:20px;">默认地址</span><?php else: ?>
  ...
  <script>
   ...
   $('#Address_Manager_xs').click(function(){
   	...
   	+
   	'<div class="text-right visible-sm visible-xs"><a id="address" href="javascript:getaddr();"   style="text-decoration: underline;">读取微信地址</a></div>';
  	layer.open({
			  title: [
			    '编辑地址',
			    'background-color:#77cde3; color:#fff;'
...
?>'+
    ...
    +
    '<div class="text-right visible-sm visible-xs"><a href="javascript:getaddr();" style="text-decoration: underline;">读取微信地址</a></div></form>'
    ;
