...
?>
                  ...
                  <a class="btn btn-primary Logistics" href="#" data-id="<?php echo $this->_var['co']['order_id']; ?>" onClick="javascript:func(<?php echo $this->_var['co']['order_id']; ?>)">快递跟踪</a>
                  </div>
                  

                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="expressmain<?php echo $this->_var['co']['order_id']; ?>" style="border-top: 2px dashed #ededed;display:none;">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 exname" id="couriername"><?php echo $this->_var['co']['shipping_name']; ?></div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 exnumber"><?php echo $this->_var['co']['invoice_no']; ?></div>
