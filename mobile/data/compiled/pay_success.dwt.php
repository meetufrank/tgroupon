...
<body class="page-preloading">
 ...
 <?php echo $this->fetch('head.dwt'); ?>
    ...
    <section class="container padding-top padding-bottom">
      ...
      <?php $_from = $this->_var['xh']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'xh_0_06909000_1488446157');if (count($_from)):
    foreach ($_from AS $this->_var['xh_0_06909000_1488446157']):
?>
      <div class="col-lg-3 col-sm-6 mobile-indent">
        <div class="shop-item">
        <div class="shop-thumbnail">
          <a href="shop-single.php?id=<?php echo $this->_var['xh_0_06909000_1488446157']['goods_id']; ?><?php echo $this->_var['linestring2']; ?>" class="item-link"></a>
          <?php if ($this->_var['xh_0_06909000_1488446157']['attributeimg']): ?><img src="././admin/<?php echo $this->_var['xh_0_06909000_1488446157']['attributeimg']; ?>" alt="Shop item"><?php endif; ?>
        </div>
               <div class="shop-item-details">
                    <div class="shop-item-title"><a href="shop-single.php?id=<?php echo $this->_var['xh_0_06909000_1488446157']['goods_id']; ?><?php echo $this->_var['linestring2']; ?>"><?php echo $this->_var['xh_0_06909000_1488446157']['goods_name']; ?></a></div>
                  </div>
                  <div class="shop-item-details">
                    <div class="shop-item-price">
                    <?php if ($this->_var['xh_0_06909000_1488446157']['falseprice'] > $this->_var['xh_0_06909000_1488446157']['attributeprice']): ?>
                      <span class="lead-shop-select text-normal text-gray text-crossed">￥<?php echo $this->_var['xh_0_06909000_1488446157']['falseprice']; ?></span>
                    <?php endif; ?>
                      ￥<?php echo $this->_var['xh_0_06909000_1488446157']['attributeprice']; ?>
                    </div>
                 </div>
        </div>
      </div>
