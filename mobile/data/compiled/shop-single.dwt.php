   ...
   <?php echo $this->fetch('head.dwt'); ?>
    ...
    <section class="hero-slider">
      ...
      <div class="inner">
        ...
        <?php $_from = $this->_var['xiangce']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'xiangce_0_59413400_1487935703');if (count($_from)):
    foreach ($_from AS $this->_var['xiangce_0_59413400_1487935703']):
?>

            <div class="slide pc-thumbnail" style="background-image:url(../<?php echo $this->_var['xiangce_0_59413400_1487935703']['img_url']; ?>);"></div>
  ...
  if($(".mobile_input").length<=1&&$(".mobile_li").length<=1){
    ...
    <div class="row">
       ...
       <div class="artist-lf col-lg-6 col-md-6 col-sm-6">
           ...
           <?php $_from = $this->_var['spysj']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'spysj_0_59501800_1487935703');if (count($_from)):
    foreach ($_from AS $this->_var['spysj_0_59501800_1487935703']):
?>

                 <p>

                  <img src="..<?php echo $this->_var['spysj_0_59501800_1487935703']['hav_logo']; ?>" style="width:80px;height:80px;border:1px solid transparent;border-radius:50px; float:left;">

                  <span style="margin-top:20px;margin-left:15px; margin-right:15px;display:inline-block; font-size:16px; font-weight:blod;"><?php echo $this->_var['spysj_0_59501800_1487935703']['user_name']; ?></span>

                  <img src="<?php echo $this->_var['ectouch_themes']; ?>/img/shugang.png" style="display:inline-block; width:1px; height:30px;">

                  <span style="margin-top:15px;margin-left:15px;display:inline-block;font-size:16px; font-weight:bloder;"><?php echo $this->_var['spysj_0_59501800_1487935703']['country']; ?></span>
        ...
        <div role="tabpanel" class="tab-pane transition fade in active" id="description">
          ...
          <div class="row space-top">
            ...
            <div class="space-bottom" id="xiangqiangimg">
                ...
                <?php $_from = $this->_var['goodsdesc']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goodsdesc_0_59508800_1487935703');if (count($_from)):
    foreach ($_from AS $this->_var['goodsdesc_0_59508800_1487935703']):
?>

                   <?php echo $this->_var['goodsdesc_0_59508800_1487935703']['goods_desc']; ?>
          ...
          <div class="row">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table-no-border">
                                ...
                                <?php $_from = $this->_var['spguige']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'spguige_0_59513100_1487935703');if (count($_from)):
    foreach ($_from AS $this->_var['spguige_0_59513100_1487935703']):
?>

                                  <tr class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pc-guige-class">

                                    <td class="tab-shopsingle"><?php echo $this->_var['spguige_0_59513100_1487935703']['attr_name']; ?>:</th>

                                    <td class="tab-shopsingle-right"><?php echo $this->_var['spguige_0_59513100_1487935703']['attr_value']; ?></td>
    ...
    <section class="container padding-top padding-bottom">
      ...
      <div class="row padding-top">
        ...
        <?php $_from = $this->_var['xh']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'xh_0_59520900_1487935703');if (count($_from)):
    foreach ($_from AS $this->_var['xh_0_59520900_1487935703']):
?>
              ...
              <div class="col-lg-3 col-sm-6 mobile-indent">
                ...
                <div class="shop-item">
                  ...
                  <div class="shop-thumbnail">
                    ...
                    <a href="shop-single.php?id=<?php echo $this->_var['xh_0_59520900_1487935703']['goods_id']; ?><?php echo $this->_var['linestring2']; ?>" class="item-link"></a>

                    <?php if ($this->_var['xh_0_59520900_1487935703']['attributeimg']): ?><img src="././admin/<?php echo $this->_var['xh_0_59520900_1487935703']['attributeimg']; ?>" alt="Shop item"><?php endif; ?>

                  </div>

                  <div class="shop-item-details">

                    <h3 class="shop-item-title"><a href="shop-single.php?id=<?php echo $this->_var['xh_0_59520900_1487935703']['goods_id']; ?><?php echo $this->_var['linestring2']; ?>"><?php echo $this->_var['xh_0_59520900_1487935703']['goods_name']; ?></a></h3>

                    <span class="shop-item-price">

                      <span class="old-price"></span>

                      ￥<?php echo $this->_var['xh_0_59520900_1487935703']['attributeprice']; ?>
