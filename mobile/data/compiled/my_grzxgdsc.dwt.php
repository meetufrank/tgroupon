        ...
        <div role="tabpanel" class="tab-pane transition fade active in" id="tab2">
		      ...
		      <div id="btn-sm" class="tab-content">
		        <div role="tabpanel" class="tab-pane transition fade in active" id="tab2_1">
		        	<div class="row">
					 <?php $_from = $this->_var['spxx']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'spxx_0_49098600_1483349557');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['spxx_0_49098600_1483349557']):
        $this->_foreach['no']['iteration']++;
?>
						  <div class="col-md-3 col-sm-6" id="spdel<?php echo $this->_var['spxx_0_49098600_1483349557']['rec_id']; ?>">
						  <div class="shop-item">
							<div class="shop-thumbnail">
							  <a href="shop-single.php?id=<?php echo $this->_var['spxx_0_49098600_1483349557']['goods_id']; ?>" class="item-link"></a>
							  <img src="../<?php echo $this->_var['spxx_0_49098600_1483349557']['goods_img']; ?>" alt="Shop item">
							  <div class="shop-item-tools">
								<a href="#" onclick="shangpingdel(<?php echo $this->_var['spxx_0_49098600_1483349557']['rec_id']; ?>)" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="">
								  <i class="material-icons close"></i>
								</a>
							  </div>
							</div>
							<div class="shop-item-details">
							  <h3 class="shop-item-title text-center"><a href=""><?php echo $this->_var['spxx_0_49098600_1483349557']['goods_name']; ?></a></h3>
							</div>
						  </div>
						</div>
				...
				<?php $_from = $this->_var['ysjxx']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ysjxx_0_49098600_1483349557');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['ysjxx_0_49098600_1483349557']):
        $this->_foreach['no']['iteration']++;
?>
								<div class="col-md-2 col-sm-3" id="ysjdelid<?php echo $this->_var['ysjxx_0_49098600_1483349557']['scid']; ?>">
								  <div class="teammate">
									<div class="teammate-thumb">
									  <div class="social-bar text-right space-bottom">
										<a href="#" class="btn btn-square btn-sm btn-primary waves-effect waves-light" onclick="ysjdel(<?php echo $this->_var['ysjxx_0_49098600_1483349557']['scid']; ?>)"><i class="material-icons close"></i></a>
									  </div>
									  <img src="<?php echo $this->_var['ysjxx_0_49098600_1483349557']['hav_logo']; ?>" alt="">
									</div>
									<h4 class="teammate-name"><a href=""><?php echo $this->_var['ysjxx_0_49098600_1483349557']['user_name']; ?></a></h4>
								  </div>
								</div>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
							</div>
