...
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('fengchen_list.htm'), '', array('filter' => $goodsdb['filter'], 'page_count' => $goodsdb['page_count']));
}
elseif ($_REQUEST['act'] == 'del')
{
    ...
    $db->query($sql);
    $links[] = array('text' => $_LANG['article_auto'], 'href' => 'fengchen_list.php?act=list');
...
elseif ($_REQUEST['act'] == 'batch_start')
{
    ...
    $lnk[] = array('text' => $_LANG['back_list'], 'href' => 'fengchen_list.php?act=list');
