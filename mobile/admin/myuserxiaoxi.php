...

{
    ...
    $smarty->assign('action_link',  array('text' => $_LANG['04_users_add'], 'href'=>'myuserxiaoxi.php?act=add'));
...
select count(*) from `ecs_xiaoxi`";
    ...
    $smarty->display('myuserxiaoxi_list.htm');
...

{
    ...
    $smarty->assign('action_link',      array('text' => $_LANG['03_users_list'], 'href'=>'myuserxiaoxi.php?act=list'));
